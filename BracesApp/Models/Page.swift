...
struct Page : Identifiable {
    ...
    static var pages : [Page] = [Page(image: "Selfie", text: "Welcome to SmileTracker! This is a fun app used to visually track the progress of your tooth alignment.", tag: 0),
                                 Page(image: "Clean", text: "SmileTracker lets you keep your camera roll clutter free by localizing all your progress pictures to one app.", tag: 1),
                                 Page(image: "Video", text: "Lastly, you can stitch all your progress photos into a single video for you to share with your friends, family, or dentist!", tag: 2),
